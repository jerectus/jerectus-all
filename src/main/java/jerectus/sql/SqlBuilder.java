...
public class SqlBuilder<T> {
    ...
    public SqlBuilder<T> in(TryConsumer<SqlBuilder<?>> cn) {
    ...
    public SqlBuilder<T> with(TryConsumer<SqlBuilder<T>> cn) {
        cn.accept(this);
        return this;
    }
    ...
    public void forEach(TryConsumer<T> cn) {
        execute().forEach(cn);
    }

    public void forEach(TryBiConsumer<T, SqlQueryResult> cn) {
        execute().forEach(cn);
    }
